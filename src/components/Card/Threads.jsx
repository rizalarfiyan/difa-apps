...
import { htmlTags, routeReplace, timeAgo } from '@utils'
import { Link } from 'react-router-dom'
import { Button, Icon } from '@components'
import { ROUTE } from '@constants'

function Threads({ thread, userById }) {
...
Threads.propTypes = {
  thread: PropTypes.shape({
    ...
    upVotesBy: PropTypes.string.isRequired,
    downVotesBy: PropTypes.string.isRequired,
  }).isRequired,
