...
const useActionThread = ({ id, me, like, dislike, hasLike, hasDislike }) => {
  ...
  const [upVote, upVoteState] = threads.services.useUpVoteThreadMutation()
  const [downVote, downVoteState] = threads.services.useDownVoteThreadMutation()
  const [neutralVote, neutralVoteState] =
    threads.services.useNeutralVoteThreadMutation()
